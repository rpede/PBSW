...
set tabstop=4
set textwidth=79
set wildignore=*.pyc,*.bak,*.pyc,*.class
let s:so_save = &so | let s:siso_save = &siso | set so=0 siso=0
let v:this_session=expand("<sfile>:p")
silent only
cd ~/Documents/PBSW/1_semester/test/exam
